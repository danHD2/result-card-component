function Result() {
    return (
        <div className='graphics p-12 rounded-3xl flex flex-col items-center bg-gradient-to-b from-lightSlateBlue to-lightRoyalBlue text-white'>
        ...
        <p className='grade text-2xl py-5'>Great</p>
